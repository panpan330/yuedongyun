...
CREATE TABLE `question`  (
  ...
  `cate_id1` bigint NOT NULL COMMENT '1级训练分类id',
  `cate_id2` bigint NOT NULL COMMENT '2级训练分类id',
  `cate_id3` bigint NOT NULL COMMENT '3级训练分类id',
