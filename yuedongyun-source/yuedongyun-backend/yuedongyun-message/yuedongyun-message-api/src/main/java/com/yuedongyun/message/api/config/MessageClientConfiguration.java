package com.yuedongyun.message.api.config;
...
import static com.yuedongyun.common.constants.Constant.*;

@Configuration
@EnableFeignClients(basePackages = "com.yuedongyun.message.api.client")
