package com.yuedongyun.campaign.domain.vo;

import com.yuedongyun.common.utils.DateUtils;
import com.yuedongyun.campaign.enums.DiscountType;
...
public class VoucherDetailVO {
    ...
    @ApiModelProperty("优惠券使用范围，key范围类型(0-没有限制，1-限定分类，2-限定训练)，值是范围ID")
    private List<VoucherScopeVO> scopes;
