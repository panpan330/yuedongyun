package com.yuedongyun.exam.controller;
...
public class QuestionController {
    ...
    @ApiOperation("查询教练出题数量")
    @GetMapping("/numOfCoach")
    public Map<Long, Integer> countAssessmentNumOfCoach(
            @ApiParam("要查询的教练的集合") @RequestParam("ids") List<Long> createrIds){
