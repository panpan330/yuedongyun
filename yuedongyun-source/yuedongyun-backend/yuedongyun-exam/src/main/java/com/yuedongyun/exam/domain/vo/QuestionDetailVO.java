package com.yuedongyun.exam.domain.vo;
...
public class QuestionDetailVO {
    ...
    @ApiModelProperty("1级训练分类id")
    private Long cateId1;

    @ApiModelProperty("2级训练分类id")
    private Long cateId2;

    @ApiModelProperty("3级训练分类id")
    private Long cateId3;
    @ApiModelProperty("训练三级分类的名称集合")
