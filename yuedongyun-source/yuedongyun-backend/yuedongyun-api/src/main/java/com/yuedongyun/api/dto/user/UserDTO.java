package com.yuedongyun.api.dto.user;

import com.yuedongyun.common.constants.RegexConstants;
...
public class UserDTO {
    ...
    private String name;
    @ApiModelProperty(value = "用户类型，1-其他员工,2-普通会员，3-教练", example = "2")
    @EnumValid(enumeration = {1,2,3}, message = "用户类型错误")
    @NotNull
    private Integer type;
    @ApiModelProperty(value = "角色id，教练和会员不用填", example = "5")
    private Long roleId;
    @ApiModelProperty(value = "头像", example = "default-user-icon.jpg")
    private String icon;
    @ApiModelProperty(value = "岗位", example = "教练")
    private String job;
    @ApiModelProperty(value = "个人介绍", example = "悦动云体能教练")
    private String intro;
    @ApiModelProperty(value = "形象照地址", example = "default-coach-photo.jpg")
