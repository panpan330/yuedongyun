package com.yuedongyun.api.client.exam;
...
public interface ExamClient {
    ...
    @GetMapping("/questions/numOfCoach")
    Map<Long, Integer> countAssessmentNumOfCoach(@RequestParam("ids") Iterable<Long> createrIds);
