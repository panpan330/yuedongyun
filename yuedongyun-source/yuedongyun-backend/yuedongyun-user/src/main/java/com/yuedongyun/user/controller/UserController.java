...
import com.yuedongyun.user.constants.UserErrorInfo;
...
public class UserController {
     ...
     *
     * @param id 用户id
     * @return 用户类型，0-普通会员，1-教练，2-其他员工
     */
    @ApiIgnore
    @GetMapping("/{id}/type")
    ...
    public Boolean checkCellPhone(@RequestParam("cellphone") String cellPhone){
        return userService.lambdaQuery()
                ...
                // .in(User::getType, UserType.STAFF, UserType.COACH)
                .count() <= 0;
    }
}
