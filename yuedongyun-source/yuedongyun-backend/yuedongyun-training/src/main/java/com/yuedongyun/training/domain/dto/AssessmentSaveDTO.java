...
import com.yuedongyun.training.constants.AssessmentConstants;
...
@ApiModel("题目保存模型")
@Data
public class AssessmentSaveDTO implements Checker {
    ...
    public void check() {
        //选择题 单选，多选，不定向选择
        if(assessmentType == AssessmentConstants.Type.SIGNLE_CHOICE.getType() ||
                assessmentType == AssessmentConstants.Type.MUtiple_CHOICE.getType() ||
                assessmentType == AssessmentConstants.Type.NON_DIRECTIONAL_CHOICE.getType()){
