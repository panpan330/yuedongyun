package com.yuedongyun.training.domain.query;
...
public class TrainingPageQuery extends PageQuery {
    ...
    @ApiModelProperty(value = "训练2级分类id", example = "2")
    private Long secondCateId;
    @ApiModelProperty(value = "训练3级分类id", example = "3")
    private Long thirdCateId;
    @ApiModelProperty(value = "售卖模式，true：免费，false：收费", example = "true")
    private Boolean free;
    @ApiModelProperty(value = "训练状态，1：待上架，2：已上架，3：已下架，4：已完结", example = "1", required = true)
