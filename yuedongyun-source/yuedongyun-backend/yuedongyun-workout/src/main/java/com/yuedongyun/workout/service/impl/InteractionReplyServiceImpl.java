...
import com.yuedongyun.workout.enums.QuestionStatus;
...
import static com.yuedongyun.common.constants.Constant.DATA_FIELD_NAME_CREATE_TIME;
import static com.yuedongyun.common.constants.Constant.DATA_FIELD_NAME_LIKED_TIME;
...
public class InteractionReplyServiceImpl extends ServiceImpl<InteractionReplyMapper, InteractionReply> implements IInteractionReplyService {
    ...
    public void saveReply(ReplyDTO replyDTO) {
        ...
        questionService.lambdaUpdate()
                ...
                .set(replyDTO.getIsMember(), InteractionQuestion::getStatus, QuestionStatus.UN_CHECK.getValue())
                .eq(InteractionQuestion::getId, replyDTO.getQuestionId())
                .update();

        // 4.尝试累加积分
        if(replyDTO.getIsMember()) {
            // 会员才需要累加积分
            mqHelper.send(
                    MqConstants.Exchange.WORKOUT_EXCHANGE,
