...
import com.yuedongyun.workout.service.ISignRecordService;
...
public class SignRecordServiceImpl implements ISignRecordService {
    ...
    public SignResultVO addSignRecords() {
        ...
        mqHelper.send(
                ...
                SignInMessage.of(userId, rewardFitPoint + 1));
        // 5.封装返回
        SignResultVO vo = new SignResultVO();
        vo.setSignDays(signDays);
        vo.setRewardFitPoint(rewardFitPoint);
        return vo;
    }
