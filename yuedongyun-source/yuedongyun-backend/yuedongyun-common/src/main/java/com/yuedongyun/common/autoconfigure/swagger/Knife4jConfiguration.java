package com.yuedongyun.common.autoconfigure.swagger;

import cn.hutool.core.convert.ConverterRegistry;
import com.fasterxml.classmate.TypeResolver;
import com.yuedongyun.common.domain.R;
import com.yuedongyun.common.utils.TjTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "yuedongyun.swagger", name = "enable",havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "yuedongyun.swagger", name = "enableResponseWrap",havingValue = "true")
