...
import com.yuedongyun.media.storage.tencent.TencentFileStorage;
import com.yuedongyun.media.storage.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "yuedongyun.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "yuedongyun.platform", name = "file", havingValue = "TENCENT")
