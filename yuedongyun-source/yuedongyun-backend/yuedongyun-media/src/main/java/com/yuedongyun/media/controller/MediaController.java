package com.yuedongyun.media.controller;
...
public class MediaController {
    ...
    public VideoPlayVO getPlaySignature(
            @ApiParam(value = "小节id", example = "1", required = true) @RequestParam("sessionId") Long sessionId){
        return mediaService.getPlaySignatureBySessionId(sessionId);
    }
