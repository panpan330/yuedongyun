...
<template>
  <div class="typeBox">
    ...
    >
      ...
      <el-table-column label="训练数量" prop="trainingNum" min-width="160">
      </el-table-column>
...
// 接口api
import { deleteType, editProgramStatus } from "@/api/program"
// 导入组件
// 删除弹出层
...
const handleStatus = async (status) => {
  ...
  await editProgramStatus(params)
    .then((res) => {
      if (res.code === 200) {
        let mes = ""
        if (status === 1) {
