<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="会员手机号：" prop="cellPhone">
...
// 控制字节数
import { validatemembersPhone, validatemembers } from "@/utils/validate.js";
// 引用公用数据中的性别
...
const rules = reactive({
  ...
  cellPhone: [
    { required: true, validator: validatemembersPhone, trigger: "blur" },
  ],
