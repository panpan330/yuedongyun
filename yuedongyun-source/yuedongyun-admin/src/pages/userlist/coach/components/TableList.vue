...
<template>
  <div @keydown="handleEsc">
    ...
    <el-table
      ...
      class="coachTableList"
    >
      <el-table-column type="index" align="center" width="100" label="序号" />
      <el-table-column
        label="教练名称"
        min-width="240"
        class-name="coachname"
      >
      ...
      <el-table-column prop="cellPhone" label="教练手机号" min-width="160" />
      <el-table-column
        prop=""
        label="岗位"
        min-width="215"
      ...
      <el-table-column label="教练介绍" min-width="350" class-name="textLeft">
        <template #default="scope">
          <div class="ellipsisHidden2">
            <el-popover
      ...
      <el-table-column prop="trainingAmount" label="负责训练数量" min-width="150">
      </el-table-column>
      <el-table-column
...
let pic = ref("") //要放大的图片
let teachId = ref("") //要重置的教练id
let teachName = ref("") //教练名称
