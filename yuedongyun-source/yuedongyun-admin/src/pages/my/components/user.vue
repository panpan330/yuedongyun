<template>
  ...
  >
    ...
    <el-form-item label="旧密码：" v-show="isTraining" prop="oldPassword">
      <div class="el-input">
        <el-input
          type="password"
    ...
    <el-form-item label="新密码：" v-show="isTraining" prop="password">
      <div class="el-input">
        <el-input
          type="password"
    ...
    <el-form-item label="确认新密码：" v-show="isTraining" prop="checkpassword">
      <div class="el-input">
        <el-input
          type="password"
