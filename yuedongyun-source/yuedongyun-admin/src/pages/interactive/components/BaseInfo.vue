...
<template>
  <div class="bg-wt radius marg-tp-20">
    <div class="questionBox">
      ...
      <div class="food">
        <ul>
          <li><span class="littletitle">训练分类：</span><span>{{ baseData.categoryName }}</span></li>
          <li>训练内容：{{ baseData.trainingName }}</li>
          <li class="end">
            负责教练：{{
              baseData.coachName || ""
            }}
          ...
          <li>
            <p class="littletitle">所属小节：</p><p>{{ baseData.phaseName }}/{{ baseData.sessionName }}</p>
          </li>
          <li>
            回答数量：{{
