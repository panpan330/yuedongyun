  ...
  <div>
    <div>
      ...
      <el-table :data="baseData" border stripe v-loading="loading">
        ...
        >
          <template #default="scope">
            {{ scope.row.phaseName }}-{{ scope.row.sessionName }}
          </template>
        </el-table-column>
        <el-table-column label="训练内容" prop="trainingName" width="350">
        </el-table-column>
        <el-table-column prop="categoryName" label="训练分类" width="350">
        </el-table-column>
        <el-table-column prop="userName" label="提问会员昵称" min-width="150">
        </el-table-column>
        <el-table-column
          prop="answerAmount"
          label="回答数量"
