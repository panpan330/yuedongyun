    ...
    <div class="pad-30 searchForm">
      <el-form ref="ruleForm" :inline="true" :model="searchData">
        <el-row :gutter="30">
          ...
          <el-col :span="6">
            <el-form-item label="商城券状态" prop="status">
              <div class="el-input">
                <el-select
...
// 公用数据
// 公用数据
import { vouchersTypeData,vouchersStatusData } from "@/utils/commonData";
// 获取父组件值、方法
...
const baseTypeData = vouchersTypeData; //优惠卷类型
const baseStatusData = vouchersStatusData; //优惠券状态
// ------定义方法------
// 搜索
const handleSearch = () => {
  emit("handleSearch");
