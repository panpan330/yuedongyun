    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          <p>请使用<em> {{payMethod.name}} </em>扫一扫</p> <p>扫码完成订单支付</p>
        </div>
      </template>
    </el-dialog>
  </div>
