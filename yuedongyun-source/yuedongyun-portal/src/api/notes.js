...
export const getAllNotes = params =>
	request({
		url: `${WORKOUT_API_PREFIX}/notes/page`,
		method: 'get',
		params,
	})
// 采集笔记
export const collectionNotes = id =>
	request({
		url: `${WORKOUT_API_PREFIX}/notes/${id}`,
		method: 'post'
	})    
// 更新笔记
export const updateNotes = data =>
	request({
		url: `${WORKOUT_API_PREFIX}/notes/${data.id}`,
		method: 'put',
		data
	})      
...
request({
	url: `${WORKOUT_API_PREFIX}/notes/gathers/${id}`,
	method: 'post',
})	
// 取消采集笔记
...
request({
	url: `${WORKOUT_API_PREFIX}/note/${id}`,
	method: 'post',
})	
// 取消笔记点赞
